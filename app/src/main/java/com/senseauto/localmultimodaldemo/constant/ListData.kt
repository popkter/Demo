...
val ListData = listOf(
    MainSceneItem(
        ...
        title = "多模态大模型让车舱具备了极致了的感知和理解能力，可以结合环境和您的心情打招呼，试试和AI对话吧。",
        scenes = listOf(
            SubSceneItem(
                sceneCover = -1,
                hints = listOf(
    ...
    MainSceneItem(
        ...
        title = "多模态大模型能更准确地“看懂”乘客的百变状态，如果看到乘客睡着，AI会及时调控音响和空调。",
        scenes = listOf(
            SubSceneItem(
    ...
    MainSceneItem(
        ...
        title = "多模态大模型能更准确地“看懂”乘客的百变状态，儿童把手伸出窗外时，AI会给出及时的提醒告警。",
        scenes = listOf(
            SubSceneItem(
    ...
    MainSceneItem(
        ...
        title = "多模态大模型让车舱具备了极致的感知和理解能力，不知道如何化妆为好的女士们，AI可以为您提建议。",
        scenes = listOf(
            SubSceneItem(
    ...
    MainSceneItem(
        ...
        title = "多模态大模型能更准确地“看懂”舱外的复杂场景，引导智能汽车更聪明地行驶。",
        scenes = listOf(
            SubSceneItem(
    ...
    MainSceneItem(
        ...
        scenes = listOf(
            ...
            SubSceneItem(
                sceneCover = R.drawable.scene_cover_police_gesture_identify_5,
                hints = listOf(
                    HintItem(
                        hint = "描述一下车辆前方的场景",
                        prompt = "用八十个字左右描述一下车辆前方的场景不要截断"
